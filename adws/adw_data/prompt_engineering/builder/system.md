...
- **Use `codegraph_explore` before editing** — query the knowledge graph to understand the symbols you'll touch, their callers, and their dependencies. This prevents blind edits that break downstream code.
