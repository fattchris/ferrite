...
# watch it, and open the trace. Add your own as your chains grow.
...
obs:
    cd .hermes/skills/sssf/apps/visualizer && bun install && (SSSF_DB={{justfile_directory()}}/{{db}} bun run server/index.ts &) && bunx vite
